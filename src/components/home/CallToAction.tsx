  ...
  const courses = [
    {
      ...
      description:
        'Курс знайомить дітей з основами графічного дизайну та навчає працювати в сучасному онлайн-сервісі Canva.',
      age: '7-15 років',
      duration: '9 місяців',
      color: '#78C86F',
      colorClass: 'accent',
    ...
    },
    {
      ...
      description:
        'Курс знайомить дітей з основами UI/UX дизайну та навчає працювати в сучасному інструменті Figma.',
      age: '7-15 років',
      duration: '9 місяців',
      color: '#5A7F46',
      colorClass: 'red',
    ...
    },
    {
      ...
      description:
        'Drone-напрямок — авторська програма, що поєднує комплексне вивчення дронів через інженерію, електроніку, 3D-моделювання та основи програмування.',
      age: '7-15 років',
      duration: '9 місяців',
      color: '#4E9D4A',
      colorClass: 'blue',
